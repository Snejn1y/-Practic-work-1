using Practic._4_ïðàêòè÷íà;
using Practic._5__ïðàêòè÷íà;
...
namespace Practic
{
    public partial class Form1 : Form
    {
        ...
        private void ïðàêòèíàToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void ïðàêòè÷íàToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Pract5 f = new Pract5();
            f.Show();
            this.Hide();
